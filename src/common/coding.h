...
extern void PutLengthPrefixedStringPiece(std::string* dst,
...
extern bool GetLengthPrefixedStringPiece(StringPiece* input,
                                         StringPiece* result);
...
extern const char* GetVarint32Ptr(const char* p,
                                  const char* limit,
                                  uint32_t* v);
extern const char* GetVarint64Ptr(const char* p,
                                  const char* limit,
                                  uint64_t* v);
