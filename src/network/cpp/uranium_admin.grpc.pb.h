 ...
 public:
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status GetTableOptions(::grpc::ClientContext* context, const ::uranium::common::TableName& request, ::uranium::admin::GetTableOptionsResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::uranium::admin::GetTableOptionsResponse>> AsyncGetTableOptions(::grpc::ClientContext* context, const ::uranium::common::TableName& request, ::grpc::CompletionQueue* cq) {
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::uranium::admin::GetTableOptionsResponse>* AsyncGetTableOptionsRaw(::grpc::ClientContext* context, const ::uranium::common::TableName& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub GRPC_FINAL : public StubInterface {
   public:
    ...
    ::grpc::Status GetTableOptions(::grpc::ClientContext* context, const ::uranium::common::TableName& request, ::uranium::admin::GetTableOptionsResponse* response) GRPC_OVERRIDE;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::uranium::admin::GetTableOptionsResponse>> AsyncGetTableOptions(::grpc::ClientContext* context, const ::uranium::common::TableName& request, ::grpc::CompletionQueue* cq) {
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::uranium::admin::GetTableOptionsResponse>* AsyncGetTableOptionsRaw(::grpc::ClientContext* context, const ::uranium::common::TableName& request, ::grpc::CompletionQueue* cq) GRPC_OVERRIDE;
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status GetTableOptions(::grpc::ServerContext* context, const ::uranium::common::TableName* request, ::uranium::admin::GetTableOptionsResponse* response);
  };
  ...
  class WithAsyncMethod_GetTableOptions : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetTableOptions(::grpc::ServerContext* context, const ::uranium::common::TableName* request, ::uranium::admin::GetTableOptionsResponse* response) GRPC_FINAL GRPC_OVERRIDE {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetTableOptions(::grpc::ServerContext* context, ::uranium::common::TableName* request, ::grpc::ServerAsyncResponseWriter< ::uranium::admin::GetTableOptionsResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
