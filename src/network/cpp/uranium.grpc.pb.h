...
class UraniumSchemalessService GRPC_FINAL {
 public:
  class StubInterface {
   public:
    ...
    // INVALID_TYPE error is returned when key does not hold a k-v pair value.
    ...
    // push operations.
    // TABLE_NOT_FOUND error is returned when the table does not yet exist.
    // INVALID_TYPE error is returned when key does not hold a list.
    ...
    // TABLE_NOT_FOUND error is returned when the table does not yet exist.
    // KEY_NOT_FOUND error is returned when key does not yet exist.
    // INVALID_TYPE error is returned when the key does not hold a list.
    ...
    // INVALID_TYPE error is returned when the key does not hold a hash.
    ...
    // TABLE_NOT_FOUND error is returned when the table does not yet exist.
    // INVALID_TYPE error is returned when the key does not hold a set.
  ...
  typedef WithAsyncMethod_KVGet<WithAsyncMethod_KVSet<WithAsyncMethod_KVRemove<WithAsyncMethod_ListLPush<WithAsyncMethod_ListLPop<WithAsyncMethod_ListRPush<WithAsyncMethod_ListRPop<WithAsyncMethod_ListLPushX<WithAsyncMethod_ListRPushX<WithAsyncMethod_ListIndex<WithAsyncMethod_ListSet<WithAsyncMethod_ListRange<WithAsyncMethod_ListLength<WithAsyncMethod_ListRemoveAll<WithAsyncMethod_HashGet<WithAsyncMethod_HashGetAll<WithAsyncMethod_HashGetAllFields<WithAsyncMethod_HashGetAllValues<WithAsyncMethod_HashLength<WithAsyncMethod_HashSet<WithAsyncMethod_HashSetX<WithAsyncMethod_HashRemove<WithAsyncMethod_HashExists<WithAsyncMethod_HashRemoveAll<WithAsyncMethod_SetAdd<WithAsyncMethod_SetLength<WithAsyncMethod_SetIsMember<WithAsyncMethod_SetGetAll<WithAsyncMethod_SetRemove<WithAsyncMethod_SetRemoveAll<Service > > > > > > > > > > > > > > > > > > > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
